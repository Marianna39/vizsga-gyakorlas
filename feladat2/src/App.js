...
function App() {
  ...
  return (
    <div className="container">
      ...
      <p>Az antikváriumot 1901-ben alapították, még az Osztrák-Magyar Monarchia idején. Magát az épületet többször újjá kellett építeni, ez azonban lehetőséget adott a megújításra, korszerűsítésre.
      </p>
      ...
      <div className="row">
        <div className="col-md-4">
          <div className="card-p-t">
            <h3>Móra Ferenc</h3>
            <p>Az Én Újságom c. gyermeklapba írt művei közül 50-nek a kéziratát az antikváriumnak adományozta
            </p>
